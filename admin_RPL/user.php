        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Kelola Pengguna Disini</p>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                $data_ttl = $row['tempat_tanggal_lahir'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger btn-sm" name="btn_hapus" data-toggle="modal" data-target="#modalHapusUser<?php echo $data_id; ?>">Hapus</button>
                                        </td>
                                    </tr>

                                   <!-- Modal Hapus User -->
                                    <div class="modal fade" id="modalHapusUser<?php echo $data_id; ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST">
                                                    <div class="modal-body mb-3">
                                                        Apakah anda yakin menghapus <b><?php echo $data_nama; ?></b> dari pengguna MedCareMarket?
                                                        <div class="mb-3 mt-3 d-flex justify-content-end row-gap-3">
                                                            <button class="btn btn-danger" name="btn_hapus_user">Hapus</button>
                                                            <input type="hidden" name="id_hapus_user" value="<?php echo $data_id; ?>">
